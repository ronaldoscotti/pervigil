...
export const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    waitingOutsideWindow: "{n} waiting outside this window",
  ...
  pt: {
    ...
    waitingOutsideWindow: "{n} aguardando fora desta janela",
  ...
  es: {
    ...
    waitingOutsideWindow: "{n} esperando fuera de esta ventana",
  ...
  fr: {
    ...
    waitingOutsideWindow: "{n} en attente hors de cette fenêtre",
  ...
  de: {
    ...
    waitingOutsideWindow: "{n} warten außerhalb dieses Zeitraums",
  ...
  ru: {
    ...
    waitingOutsideWindow: "{n} ожидают вне этого окна",
  ...
  zh: {
    ...
    waitingOutsideWindow: "{n} 个在此时间范围外等待",
  ...
  ja: {
    ...
    waitingOutsideWindow: "この期間外で {n} 件が待機中",
  ...
  hi: {
    ...
    waitingOutsideWindow: "{n} इस अवधि के बाहर प्रतीक्षारत",
  ...
  ar: {
    ...
    waitingOutsideWindow: "{n} في الانتظار خارج هذه الفترة",
